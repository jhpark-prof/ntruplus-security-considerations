...
The encapsulation algorithm (see Section 6.3.1 of {{KpqC2025}}) takes as input an n-bit random message, which also SHOULD be generated by an approved RBG, where n denotes the degree of a polynomial in the ring R. 
